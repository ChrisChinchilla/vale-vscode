...
const TAG = "v0.3.5"
const URL = "https://github.com/errata-ai/vale-ls/releases/download/{tag}/vale-ls-{arch}-{platform}.zip"
...
export function activate(context: ExtensionContext) {
  ...
  let serverOptions: ServerOptions = {
		run:   { transport: TransportKind.stdio, command: valePath, args: valeArgs },
		debug: { transport: TransportKind.stdio, command: valePath, args: valeArgs }
	};
